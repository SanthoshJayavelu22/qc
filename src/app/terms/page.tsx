        ...
        <section className="bg-legalDark text-white py-16 px-6 lg:px-12">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/80 text-sm md:text-base max-w-xl mx-auto font-light">
              Quality Conveyancing Limited (Company No. 07566902) — Official Terms of Business & Client Contract.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-4xl bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-8 text-legalDark text-sm leading-relaxed">
            ...
            <div className="p-6 bg-warmGray/40 rounded-xl border border-gray-100">
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-2 text-xs text-textMuted font-medium">
                ...
                <div>2. Our Responsibilities & Services</div>
                ...
                <div>22. Litigation Provisions</div>
                <div>23. Legal Aid</div>
                <div>24. Professional Insurance</div>
                <div>25. FSCS Scheme</div>
                <div>26. Green Deal</div>
                <div>27. Severability</div>
                <div>28. Third Parties</div>
                <div>29. Force Majeure</div>
                <div>30. Law and Jurisdiction</div>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <FileCheck className="w-5 h-5 text-tealAccent" /> 1. Our Contract
              </h2>
              <p className="text-textMuted mb-3">
                ...
                Number 681223841). We are authorised by the CLC, our CLC number
                is <strong>11359</strong>.
              </p>
              ...
              <div className="bg-warmGray/30 p-4 rounded-xl text-xs space-y-2 text-textMuted border border-gray-100">
                <p>
                  <strong>"the Firm"</strong> means Quality Conveyancing and any
                  successor practice, and any service company owned or controlled
                  by or on behalf of the Firm or any of the Directors (references
                  to 'we', 'us' or 'our' in these Terms of Business are
                  references to the Firm);
                </p>
                <p>
                  <strong>"Associated Entities"</strong> means (where you are a
                  body corporate) your shareholders, directors (as individuals
                  not acting together as the Board), officers and employees,
                  subsidiaries, parent companies, and subsidiaries of parent
                  companies, and (where you are a trade association) your
                  individual members;
                </p>
                <p>
                  <strong>"Credit Period"</strong> means the period of seven (7)
                  days from the date of our invoice for our fees and/or expenses;
                </p>
                <p>
                  <strong>"Documents"</strong> means documents we create or
                  receive on your behalf (including communications from or with
                  third parties, notes of conversations and meetings, draft and
                  final documents, and instructions to and opinions of
                  barristers);
                </p>
                <p>
                  <strong>"Engagement Letter"</strong> means, in relation to any
                  Matter, the letter (or other agreement) recording the basis of
                  our engagement;
                </p>
                <p>
                  <strong>"Force Majeure"</strong> means any circumstance beyond
                  the reasonable control of the party affected by it and includes
                  telecommunications failure, power supply failure, terrorism,
                  fuel strikes, severe weather, computer breakdown, failure of
                  suppliers to meet delivery requirements, industrial disputes
                  and absence of personnel due to illness or injury;
                </p>
                <p>
                  <strong>"Matter"</strong> means any specific transaction,
                  dispute or issue in relation to which you ask us to provide
                  Services whether or not it has been defined in an Engagement
                  Letter or other agreement;
                </p>
                <p>
                  <strong>"Director"</strong> means a Director of the Firm;
                </p>
                <p>
                  <strong>"Services"</strong> means all services we provide to
                  you in relation to the relevant Matter;
                </p>
                <p>
                  <strong>"You"</strong> includes the addressee of the relevant
                  Engagement Letter and any other person identified in the
                  Engagement Letter as our client and "your" shall have a cognate
                  meaning.
                </p>
              </div>
            </div>
            ...
            {/* 2. Our Responsibilities & Services */}
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
              ...
              <ul className="list-disc pl-5 text-textMuted space-y-1 mb-4">
                ...
                <li>Advise you of any changes in the law that affect your Matter.</li>
                <li>
            ...
            <div>
              ...
              <p className="text-textMuted font-semibold text-xs bg-warmGray/50 p-3 rounded-lg border border-gray-200">
                <strong>No Cash Policy:</strong> The Firm does not accept cash
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <FileSignature className="w-5 h-5 text-tealAccent" /> 7. Our
                Invoices
              </h2>
            ...
            <div>
              ...
              <p className="text-textMuted mb-3">
                The Firm holds client monies in a designated client account in
                accordance with the Council for Licensed Conveyancers ("CLC")
                Accounts Code.
              </p>
              <p className="text-textMuted mb-3">
                The Firm does not generally hold substantial sums of client money
                for extended periods. Due to the administrative and accounting
                costs involved, the Firm will not account to you for any interest
                earned on client monies or lender funds held in the client
                account, regardless of the amount or the length of time for which
                such monies are held.
              </p>
              <p className="text-textMuted mb-3">
                You acknowledge and agree that, under the CLC Accounts Code, you
                may otherwise be entitled to interest on money held on your
                behalf. By accepting these Terms and Conditions, you give your
                informed consent to us retaining any interest earned and agree
                that we will not account to you for any interest on money held on
                your behalf, regardless of the amount or the length of time for
                which the money is held.
              </p>
              <p className="text-textMuted mb-3">
                The Firm may, at its discretion, arrange for funds to be placed
                in an interest-bearing account. If you wish to make alternative
                arrangements regarding funds held in the client account, you must
                notify the Firm immediately and in writing prior to the deposit
                of funds.
              </p>
              <p className="text-textMuted mb-3">
                If you wish to receive interest on any monies held, you must
                notify the Firm in writing before funds are deposited into the
                client account. Any alternative arrangements, including the
                placement of funds in a designated interest-bearing account,
                shall be subject to the Firm's agreement and may incur additional
                administrative charges.
              </p>
              <p className="text-textMuted mb-3">
                The Firm will normally request mortgage advance funds from your
                lender at least two working days prior to the anticipated
                completion date to reduce the risk of banking delays affecting
                completion.
              </p>
              <p className="text-textMuted mb-3">
                You acknowledge that mortgage lenders may charge interest from
                the date mortgage funds are released, regardless of whether
                completion is delayed or does not take place on the expected
                date. The Firm shall not be responsible for any interest charged
                by the lender, nor shall the Firm account to you for any interest
                it may have earned on such funds.
              </p>
              <p className="text-textMuted">
                You are responsible for reviewing your mortgage offer and
                lender's terms to understand when interest will accrue on
                mortgage funds once released.
              </p>
            </div>
            ...
            {/* 11. Custody, Retention and Transfer of Documents */}
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
              ...
              <p className="text-textMuted mb-3">
                ...
                do not charge a fee for storage.
              </p>
              <p className="text-textMuted mb-3">
            ...
            <div>
              ...
              <p className="text-textMuted mb-3">
                ...
                We will not do this without good reason.
              </p>
            ...
            <div>
              ...
              <p className="text-textMuted mb-3">
                If you are an individual you will be required to verify your
                identity using the online electronic search provider, details of
                which will be provided to you at the outset of your matter.
              </p>
              <p className="text-textMuted mb-3">
                If you are unable to use the online search provider, you will be
                required to provide us with one item from List A and one item
                from List B (please note we require certified copies if you are
                sending these by post or email (documents can be certified by
                another solicitor or an accountant). If you are bringing in the
                original documents to our offices – a member of our staff will
                make certified copies here) we will then carry out electronic
                check relying on the documents you provide.
              </p>
              ...
              <ul className="list-disc pl-5 text-textMuted space-y-1 mb-3">
                ...
                <li>
                  Directors will be required to complete the same checks as
                  listed for individuals above including an electronic ID check
              ...
              <p className="text-textMuted">
                ...
                website at www.fca.org.uk/firms/financial-services-register. If
                you have any problem in respect of such services, please let us
                know. We will try to resolve any problem quickly. If for any
                reason we are unable to resolve the problem between us, the SRA
                provides a complaint and redress scheme. We do not manufacture
                insurance products and are not an insurance company.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-textMuted mb-3">
                ...
                www.legalombudsman.org.uk; or email
            ...
            {/* 22. Provisions relating to litigation and other work in relation to disputes */}
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Gavel className="w-5 h-5 text-tealAccent" /> 22. Provisions
                relating to litigation and other work in relation to disputes
              </h2>
              <p className="text-textMuted mb-3">
                Where you instruct us in relation to the prosecution or defence
                of litigation, or in relation to any dispute (whether or not
                proceedings are in contemplation or have been commenced), we will
                assess the likely costs and risks of each stage. We will update
                you on any material changes to the likely costs and risks as your
                matter progresses.
              </p>
              <p className="text-textMuted">
                In the course of litigation, we are required to comply with court
                rules and orders and court imposed timetables. You agree to
                provide us with any necessary instructions and information within
                such time limits as may be reasonably required by us in order to
                comply with such rules and orders. Where you fail to provide
                instructions or information within the time limits required, we
                shall be entitled to apply to the court for relief from any
                sanctions imposed.
              </p>
            </div>
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Briefcase className="w-5 h-5 text-tealAccent" /> 23. Legal Aid
              </h2>
              <p className="text-textMuted">
                We do not undertake work under the Legal Aid scheme.
              </p>
            </div>
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Shield className="w-5 h-5 text-tealAccent" /> 24. Insurance
              </h2>
              <p className="text-textMuted mb-3">
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Landmark className="w-5 h-5 text-tealAccent" /> 25. Financial
            ...
            {/* 26. Green Deal Scheme */}
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Leaf className="w-5 h-5 text-tealAccent" /> 26. Green Deal
                Scheme
              </h2>
              <p className="text-textMuted">
                The Green Deal is a government initiative to improve the energy
                efficiency of properties. If you are purchasing a property that
                has a Green Deal plan attached to it, the Green Deal charges will
                be payable by the person who occupies the property from time to
                time. We will not be responsible for advising you on the Green
                Deal or the associated charges. If you require advice on the
                Green Deal, you should seek independent financial advice.
              </p>
            </div>
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <ChevronRight className="w-5 h-5 text-tealAccent" /> 27.
                Severability
              </h2>
              <p className="text-textMuted">
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Users className="w-5 h-5 text-tealAccent" /> 28. Third Parties
              </h2>
              <p className="text-textMuted">
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Clock className="w-5 h-5 text-tealAccent" /> 29. Force Majeure
              </h2>
              <p className="text-textMuted">
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-legalDark mb-3 flex items-center gap-2">
                <Gavel className="w-5 h-5 text-tealAccent" /> 30. Law and
                Jurisdiction
              </h2>
              <p className="text-textMuted">
...
// Leaf icon for Green Deal section
