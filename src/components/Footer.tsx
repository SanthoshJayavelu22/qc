...
export default function Footer() {
  ...
  return (
    <>
      ...
      {/* Footer */}
      <footer className="bg-lightBg text-legalDark pt-20 pb-8">
        <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <nav aria-label="Footer Quick Links">
              ...
              <ul className="space-y-3">
                {["Home", "Our Services", "Get a Quote", "Meet the Team", "Endorsements", "Careers", "Contact Us"].map((link) => (
                  <li key={link}>
                    <Link href="#" className="text-textMuted hover:text-tealAccent transition-colors text-sm">
                      {link}
                    </Link>
                  </li>
                ))}
            ...
            <address className="not-italic">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-textMuted text-sm">
            ...
            <address className="not-italic">
              ...
              <div className="flex items-start gap-3 text-textMuted text-sm leading-relaxed">
          ...
          <div className="border-t border-legalDark/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-textMuted">
